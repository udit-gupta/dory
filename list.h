// copied from https://github.com/arunov/adix/blob/master/include/sys/list.h
// modified!
...
/** 
  ...
  */ 
static inline void __list_add(struct list_head *newObj, struct list_head *prev, struct list_head *next){
	next->prev = newObj;
	newObj->next = next;
	newObj->prev = prev;
	prev->next = newObj;
...
/**
  ...
  * @param newObj:     new entry to be added 
